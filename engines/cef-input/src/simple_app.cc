...
SimpleApp::SimpleApp(const std::function<void(const void*, int, int)>& func) : func_(func) {
...
void SimpleApp::OnContextInitialized() {
  ...
  CefRefPtr<SimpleHandler> handler(new SimpleHandler(func_));
  ...
  if (url.empty()) {
    url = "https://www.elperiodico.cat/ca/"; // "file:///C:/Projects/avio/neurona/engines/cef-input/index.html"; // "file:///C:/Projects/avio/neurona/engines/cef-input/example.png"; // "file:///C:/Projects/avio/neurona/engines/cef-input/index.html"; // "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Circle_%28transparent%29.png/768px-Circle_%28transparent%29.png"; // "https://vector3.tv/";
  }
